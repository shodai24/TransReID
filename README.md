...
This is a *copy* of the official TransReID repository which tries to implement a TransReID with the [Swin Transformer](https://github.com/microsoft/Swin-Transformer). A YML file for running training and testing code for this branch can be found at `configs/Market/swin_transreid_sie.yml` for Market-1501 and `configs/VeRi/swin_transreid_sie.yml` for VeRi-776.
